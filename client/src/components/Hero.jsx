    ...
    return ( 
        ...
        <div className=''>
            <div className='p-10 m-5    sm:m-10'>
                <h2 className='text-slate-100 font-poppins text-3xl font-bold mb-10 leading-7 sm:text-5xl m-4'>
                    Always order delicious <br/>and fresh meals <br/>anytime
                </h2>
                <p className='text-slate-100 font-poppins text-lg leading-7 sm:text-2xl'>
